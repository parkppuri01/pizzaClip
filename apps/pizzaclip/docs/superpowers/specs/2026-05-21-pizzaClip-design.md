# pizzaClip — macOS Clipboard History App Design
...
Stored data lives only under `~/Library/Application Support/pizzaClip/`. No network calls. No analytics.
