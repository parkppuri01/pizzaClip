...
- 🌶 **핫소스 앱**: **1.2.0 공증 배포 완료**(팝업 사이트 배너 + 푸터 여유 + 설정 방침 링크, `bf02a7e`). 앱스토어 듀얼 타깃(HotSauce / HotSauce-MAS) 전환 완료 — **MAS 1.2.0 아카이브·업로드만 사용자 직접 진행 대기**. 웹 `/privacy` 신설·라이브. → `apps/hotsauce/docs/HANDOFF.md`
