...
- 🌶 **핫소스 앱**: **🍎 App Store 심사 제출 완료**(1.3.0 빌드9 · 무료 · 미국/한국). 앱 아이콘 macOS 규격화 + 팝업 배너 ON/OFF 토글 포함. 다음: 심사 결과 대기 · **직접배포 1.3.0 공증 배포로 채널 동기화**(웹은 아직 1.2.0, 빌드 10부터). → `apps/hotsauce/docs/HANDOFF.md`
