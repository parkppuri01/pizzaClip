...
> 최종 업데이트: 2026-08-06 · **이 파일 = 모노레포 인덱스 + 공통 컨텍스트.** 개별 스트림 세부는 각 스트림 핸드오프에.
...
- 🌶 **핫소스 앱**: **1.1.3 배포 완료**(제목 옆 퍼센트 표시, `ba91981`) + **앱스토어 듀얼 타깃 전환 코드 완료·미커밋**(HotSauce / HotSauce-MAS, 샌드박스 실측 근거). 웹 `/privacy` 신설. → `apps/hotsauce/docs/HANDOFF.md`
