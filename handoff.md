...
- 🌶 **핫소스 앱**: **1.2.0 공증 배포 완료**(팝업 사이트 배너 + 푸터 여유 + 설정 방침 링크, `bf02a7e`) + **앱스토어 빌드8 업로드 완료**(서명·xattr 지뢰 2개 해결). 다음: **ASC 버전 레코드 1.0 → 1.2.0** 수정 후 빌드 연결 · 메타데이터·스크린샷·심사 제출 · 앱 아이콘 macOS 규격화. → `apps/hotsauce/docs/HANDOFF.md`
