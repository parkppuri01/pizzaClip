...
> 최종 업데이트: 2026-07-09 · **이 파일 = 모노레포 인덱스 + 공통 컨텍스트.** 개별 스트림 세부는 각 스트림 핸드오프에.
...
- 🌐 **웹**: 세 앱 릴리스 반영 배포 완료(`8c26ea1`·`27d16a2`) — 다운로드/버전/릴리스노트 갱신, **웹 누락됐던 핫소스 1.1.0·1.1.1 릴리스노트 보강**. → `web/HANDOFF.md`
...
- 🥒 **피클 앱**: **1.3.3 정식 배포 완료**(저장 용량 버그 수정 + 편집기 줌 + 블러 성능 + 설정창 통일). 공증 DMG·appcast 라이브. → `apps/pickle/docs/HANDOFF.md`
- 🌶 **핫소스 앱**: **1.1.2 정식 배포 완료**(Wi-Fi 이름·위치권한 제거 + 설정창 통일). 공증 DMG·appcast 라이브. → `apps/hotsauce/docs/HANDOFF.md`
